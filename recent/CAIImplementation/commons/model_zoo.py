...
def gpt2_3b(checkpoint=True):
    return GPTLMModel(hidden_size=2048, num_layers=56, num_attention_heads=16, checkpoint=checkpoint)
...
def gpt2_7b(checkpoint=True):
    return GPTLMModel(hidden_size= 3072, num_layers=48, num_attention_heads=24, checkpoint=checkpoint)
...
def model_builder(model_size: str) -> callable:
    if model_size == "gpt2_medium":
        ...
        return gpt2_10b
    elif model_size == "gpt2_3b":
        return gpt2_3b
    elif model_size == "gpt2_5b":
        return gpt2_5b
    elif model_size == "gpt2_7b":
        return gpt2_7b
